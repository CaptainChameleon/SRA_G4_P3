...
class ParkingController(RobotController):
    ...
    def search_for_first_obstacle(self):
        ...
        dis_to_first_obs, _ = self.robot.scan_for_closest_obstacle(search_cone_degrees=160, both_sides=True)
        security_dis = 25
        ...
        self.robot.scan_for_closest_obstacle(clockwise=False, search_cone_degrees=90)
    ...
    def park_robot(self):
        ...
        first_obstacle_dis, first_obstacle_theta = self.robot.scan_for_closest_obstacle(
            clockwise=self.turned_to_left, search_cone_degrees=120
        )
